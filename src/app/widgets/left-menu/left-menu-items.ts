...
export const MENUITEMS: Menu[] = [
  {
    title: 'Designers', type: 'sub', megaMenu: true, children: [
      {
  ...
  {
    title: 'MAN', type: 'sub', megaMenu: true, children: [
      {
  ...
  {
    title: 'WOMEN', type: 'sub', megaMenu: true, children: [
      {
        title: 'Top Wear', type: 'link', children: [
          { path: '/home/left-sidebar/collection/all', title: 'shopper bags', type: 'link' },
          { path: '/home/left-sidebar/collection/all', title: 'laptop bags', type: 'link' },
  ...
  {
    title: 'KIDS', type: 'sub', megaMenu: true, children: [
      {
